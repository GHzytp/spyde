...
**[⬇ Download SpyDE v0.5.0](https://github.com/directelectron/spyde/releases/tag/v0.5.0)** — pick your platform:

| Platform | Download |
|----------|----------|
| **Windows** | [SpyDE-Setup-0.5.0.exe](https://github.com/directelectron/spyde/releases/download/v0.5.0/SpyDE-Setup-0.5.0.exe) |
| **macOS** (Apple Silicon) | [SpyDE-0.5.0-arm64-mac.zip](https://github.com/directelectron/spyde/releases/download/v0.5.0/SpyDE-0.5.0-arm64-mac.zip) |
| **Linux** | [SpyDE-0.5.0.AppImage](https://github.com/directelectron/spyde/releases/download/v0.5.0/SpyDE-0.5.0.AppImage) |
