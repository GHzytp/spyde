...
_SPYDE_STAGED_HANDLERS: dict[str, str] = {
    ...
    "maped_set_real_offset":  "spyde.backend._session_multiangle_loader.maped_set_real_offset",
    "maped_set_pair":         "spyde.backend._session_multiangle_loader.maped_set_pair",
    ...
    "toggle_phase_element": "spyde.actions.composition.toggle_phase_element",
    "set_phase_percentages": "spyde.actions.composition.set_phase_percentages",
    "set_phase_trace":     "spyde.actions.composition.set_phase_trace",
